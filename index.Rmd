...
* Master's in Marine Sciences (Sorbonne University)
...
# My PhD in few slides

.center[

**Influence of scales on temporal changes of biodiversity**

```{r, out.width="50%"}
knitr::include_graphics("images/litrev_BAE.png")
```

$\Rightarrow$ **There is no single answer: it depends on the spatial and temporal scale**
...
* How can we explain this scale dependence of biodiversity changes? 

* Empirical analysis: Ecography
